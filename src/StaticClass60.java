...
public class StaticClass60 {

    StaticClass60() throws Throwable {
        throw new Error();
    }

    public static String staticMethod246(CharSequence charsequence_0) {
        ...
        for (int i_4 = 0; i_4 < i_2; i_4++) {
            ...
            if ((var_5 < 97 || var_5 > 122) && (var_5 < 65 || var_5 > 90) && (var_5 < 48 || var_5 > 57) && var_5 != 46 && var_5 != 45 && var_5 != 42 && var_5 != 95) {
                if (var_5 == 32)
                    ...
                    byte b_6 = StaticClass52.staticMethod217(var_5);
                    stringbuilder_3.append('%');
                    int i_7 = b_6 >> 4 & 0xf;
                    if (i_7 >= 10)
